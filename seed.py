...
from app.models import Category, Product, RoleEnum, User
...
async def seed_data():
    ...
    async with AsyncSessionLocal() as session:
        ...
        products = [
            ...
            Product(
                sku="HH05",
                name="Bàn Chải Đánh Răng Đặc Biệt",
                price=35000,
                category_id=cat.id,
                stock_quantity=100,
                min_stock_level=10,
